...
cytoplasm <- read_csv("/Volumes/DG_Backup_E/SAPNAS/2021-09-29_BV2+041GFP_and_FV3/BV2+041GFP/data_output/thresholded data/041/BV2_041_GFP_THRESHOLDEDperinuclear.csv")
...
ggplot(FInal.Frame.041, aes(x=Concentration,y=Integrated_Intensity, fill=LPS))+
  geom_boxplot()+  ggtitle('041-GFP (PERINUCLEAR) n=3 normalised THRESHOLDED' )+
...
ggplot(FInal.Frame.041_nonorm, aes(x=Concentration,y=Integrated_Intensity_nonorm, fill=LPS))+
  geom_boxplot()+  ggtitle('041-GFP (PERINUCLEAR) n=3 w/o normalisation THRESHOLDED')+
  xlab(c('041-GFP concentration'))+
