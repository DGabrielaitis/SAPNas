...
# data analysis of Perinuclear and thresholded
...
ggplot(FInal.Frame.041_nonorm, aes(x=Concentration,y=Integrated_Intensity_nonorm, fill=LPS))+
  geom_boxplot()+  ggtitle('041-GFP (cytoplasm) n=3 w/o normalisation')+
  xlab(c('041-GFP concentration'))+
...
# we need to take into consideration that the wells data was accumulated for every experiment. 

# also, that there is an actual increase in fluorescence intensity in the 041 control sample- this could be 
#caused by an increase of the internalisation oft= the membrane dye.
